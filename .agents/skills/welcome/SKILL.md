---
name: welcome
description: "Greet the user when a new project starts. This mind was created from the Introspective Chat template, so the welcome introduces that template and immediately starts the adaptation conversation."
---

# Welcome the user (template: Introspective Chat)

This mind was created from a template -- a published snapshot of apps
another mind built:

- Title: Introspective Chat
- Slug: `introspective-chat`
...
1. Open with a short CUSTOM welcome that names **Introspective Chat** and gives the
